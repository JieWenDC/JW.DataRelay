...
namespace JW.DataRelay.Framework
{
    public partial class FileHelper
    {
        ...
        {
            return absolutePath.Replace(AppDomain.CurrentDomain.BaseDirectory, "~/");
        }
        ...
        /// </summary>
        /// <param name="file"></param>
        /// <param name="full">是否包括扩展名</param>
        /// <returns></returns>
        public static string GetFileName(HttpPostedFile file, bool full = false)
        {
            if (file == null)
            {
                throw new ArgumentException("无效集合数据", "file");
        ...
        /// <param name="full">是否包括扩展名</param>
        /// <returns>string</returns>
        public static string GetFileName(string filepath, bool full = false)
        {
